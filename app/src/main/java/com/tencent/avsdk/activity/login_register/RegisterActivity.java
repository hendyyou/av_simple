...
//					onSmsRegisterInfo();
    ...
    public void onSmsRegister(View view) {
        //TODO 获取验证码
        String telephone = "86-" + mUserPhoneEditText.getText().toString().trim();//电话号码-1
//		setAppId(DemoConstants.APPID, DemoConstants.ACCOUNTTYPE);
        accType = Integer.parseInt(DemoConstants.ACCOUNTTYPE);//账号类型-2
        sdkAppid = DemoConstants.APPID;//账号类型-3
