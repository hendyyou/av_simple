package com.tencent.avsdk.activity.publish;
...
import com.tencent.avsdk.constants.ImageConstant;
...
import com.tencent.avsdk.activity.detail.AvActivity;
...
//                        Toast.makeText(ctx, R.string.notify_network_timeout, Toast.LENGTH_SHORT).show();
    ...
    private void initViewUI() {
        mEditTextLiveTitle = (EditText) findViewById(R.id.live_title);//todo 标题 直播
        mButtonShow = (Button) findViewById(R.id.btn_show);//todo 按钮 开始直播
...
//                takePhoto(coverName);
                showSelectPhoneForm();
                break;
            case R.id.btn_show://todo 创建房间---------【按钮】
