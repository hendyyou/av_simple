package com.tencent.avsdk.activity.tab.programList;
...
import com.tencent.avsdk.model.LiveVideoInfo;
import com.tencent.avsdk.adapter.LiveVideoInfoAdapter;
...
//                            Toast.makeText(LiveActivity.this, "mChoseLiveVideoInfo is null !!!! ", Toast.LENGTH_SHORT).show();
                         ...
                         * 5爱心数
                         */
                        startActivity(AvActivity.newInstance(context, roomNum, mChoseLiveVideoInfo.getUserPhone(), groupId, mChoseLiveVideoInfo.getLivePraiseCount()));
                        enterRoom();
                    }
